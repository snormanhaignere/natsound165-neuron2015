...
% fclose(fid);
% 
% output_directory = '/mindhive/nklab/u/svnh/freesurfer/pitch_localizer_monkey_us158/fla_matlab/pitchloc2_combined_split_r177/smooth286mm_10whitematterPCs';
% output_directory = '/mindhive/nklab/u/svnh/freesurfer/pitch_localizer_monkey_us158';
% output_directory = '/mindhive/nklab2/svnh';
% fid = fopen([output_directory '/temp.txt'], 'w');
% % fwrite(fid, 1);
% fprintf(fid, '%d', 2);
% fclose(fid);
% fclose all;
